  ...
  return (
    <Panel className="flex h-full w-72 flex-col rounded-none border-y-0 border-l-0">
      <div className="border-b border-workspace-border p-4">
        <p className="text-xs font-medium uppercase tracking-[0.16em] text-slate-500">Agent Library</p>
        <h2 className="mt-2 text-lg font-semibold text-white">Drag agents</h2>
      </div>
      ...
      <div className="flex items-start gap-3">
        ...
        <div className="min-w-0 flex-1">
          <div className="flex items-center justify-between gap-2">
            <h3 className="truncate text-sm font-semibold text-white">{agent.title}</h3>
